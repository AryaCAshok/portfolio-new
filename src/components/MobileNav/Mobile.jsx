        ...
        <>
            <div className="mobile-nav">
                <div className="mobile-nav-header">
                    {open ? (<span className='mobile-nav-title'><i class="fa-solid fa-compass" onClick={handleOpen} ></i></span>) :
                        (<span className='mobile-nav-title'><i class="fa-solid fa-bars me-2" onClick={handleOpen} ></i></span>)}
